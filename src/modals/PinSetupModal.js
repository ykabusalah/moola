              ...
              {[[1, 2, 3], [4, 5, 6], [7, 8, 9], ['', 0, 'del']].map((row, rowIndex) => (
                <View key={rowIndex} style={{ flexDirection: 'row' }}>
                  {row.map((key, keyIndex) => (
                    ...
                    >
                      {key === 'del' ? (
                        <Svg width={28} height={24} viewBox="-2 0 28 24">
                          <Path d="M21 4H8l-7 8 7 8h13a2 2 0 002-2V6a2 2 0 00-2-2zM18 9l-6 6M12 9l6 6" stroke={t.sub} strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="translate(-2, 0)" />
                        </Svg>
                      ) : key !== '' ? (
